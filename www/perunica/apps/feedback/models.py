...
class Feedback(models.Model):
    ...
    phone = models.CharField(max_length=255, default=u'', null=True, blank=True, verbose_name=u'Phone')
    comment = models.TextField(max_length=2048, default=u'', null=True, blank=True, verbose_name=u'Comment')
